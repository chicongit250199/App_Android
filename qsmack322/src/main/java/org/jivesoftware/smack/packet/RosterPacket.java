...
public class RosterPacket extends IQ {
    ...
    public RosterPacket(boolean reversed) {
    ...
    public String getChildElementXML() {
        ...
        if (!reversed) {
        	...
        	buf.append("<query xmlns=\"jabber:iq:reverseroster\">");
        }
        synchronized (rosterItems) {
    ...
    public static class Item {
      ...
      //custom xmpp attributes added oncam
		...
		public void setPrivCall(String priv) {
			this.privCall = priv;
		}
		...
		public String toXML() {
            ...
            if (fromMe != null) {
                buf.append(" fromme=\"").append(fromMe).append("\"");
            }
            if (fromRoster != null) {
                buf.append(" fromroster=\"").append(fromRoster).append("\"");
            }
            ...
            if (privCall != null) {
                buf.append(" p_priv_call=\"").append(privCall).append("\"");
            }
            if (dropin != null) {
                buf.append(" p_dropin=\"").append(dropin).append("\"");
            }
            buf.append(">");
