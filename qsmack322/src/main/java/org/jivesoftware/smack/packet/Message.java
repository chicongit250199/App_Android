...
public class Message extends Packet {
    ...
    private String subtype;//tells if audio video or picture
    private String ack;
    private String dest;
    ...
    public AntBuddyFile getFile() {
        return file;
    }

    public void setFile(AntBuddyFile file) {
        this.file = file;
    }
    ...
    public String toXML() {
        ...
        if (getSubtype() != null) {
            buf.append(" subtype=\"").append(StringUtils.escapeForXML(getSubtype())).append("\"");
        }
        if (getAck() != null) {
            buf.append(" ack=\"").append(StringUtils.escapeForXML(getAck())).append("\"");
        }
        if (getDest() != null) {
            buf.append(" dest=\"").append(StringUtils.escapeForXML(getDest())).append("\"");
        }
        if (getTimestamp() != null) {
            buf.append(" timestamp=\"").append(StringUtils.escapeForXML(getTimestamp())).append("\"");
        }
        if (getWith() != null) {
            buf.append(" with=\"").append(StringUtils.escapeForXML(getWith())).append("\"");
        }
        if (type != Type.normal) {
    ...
    public void addExpandBody(String expandbody)
    {
    ...
    public enum Type {
        ...
        /**
         * ProfilePost message sent to a xmpp server for ProfilePost.
         */
        post,
