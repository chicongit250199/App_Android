...
public class FormField {
    ...
    public String toXML() {
        ...
        if (getCallType() != null) {
            buf.append(" calltype=\"").append(getCallType()).append("\"");
        }
        if (getCallId() != null) {
            buf.append(" callid=\"").append(getCallId()).append("\"");
        }
        if (getInviteType() != null) {
        	buf.append(" invitetype=\"").append(getInviteType()).append("\"");
        }
        if (getEndAction() != null) {
            buf.append(" endaction=\"").append(getEndAction()).append("\"");
        }
        buf.append(">");
        // Add elements
